...
/*­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­*/
 /* 0*/{7, 7, 7, 7, 7, 7, 7, 7, 7, 7,11, 7, 7, 7, 7, 7,/* 0*/
 ...
 /*70*/ 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 0, 0, 0, 0,12}/*70*/;

/* ---- Automatentabelle ---------------------------------------------*/
struct vsCon vSMatrx[][15] = {
/*          So    	  Z      	 Bu        ':'      '='    	   '<'    	'>'   	 Space  	'"'       '/'       '*'       'LF'     EOF           */
/*­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­ 0 */{{ 0,fslb},{ 1,fsl },{ 2,fgl },{ 3,fsl },{ 0,fslb},{ 4,fsl },{ 5,fsl },{ 0,fl },{ 9,fl  },{11,fl  },{ 0,fslb},{ 0,fl  },{0,bb }},
/* 1 */{{ 0,fb  },{ 1,fsl },{10,fgl },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{0,bb }},
/* 2 */{{ 0,fb  },{ 2,fsl },{10,fgl },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{0,bb }},
/* 3 */{{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 6,fsl },{ 0,fb  },{ 0,fb  },{ 0,fb },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{0,bb }},
/* 4 */{{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 7,fsl },{ 0,fb  },{ 0,fb  },{ 0,fb },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{0,bb }},
/* 5 */{{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 8,fsl },{ 0,fb  },{ 0,fb  },{ 0,fb },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{0,bb }},
/* 6 */{{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{0,bb }},
/* 7 */{{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{0,bb }},
/* 8 */{{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{0,bb }},
/* 9 */{{ 9,fsl },{ 9,fsl },{ 9,fsl },{ 9,fsl },{ 9,fsl },{ 9,fsl },{ 9,fsl },{ 9,fsl},{ 0,flb },{ 0,fb  },{ 0,fb  },{ 0,fb  },{0,bb }},
/*10 */{{ 0,fb  },{10,fgl },{10,fgl },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{0,bb }},
/*11 */{{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb },{ 0,fb  },{14,fl  },{12,fl  },{ 0,fb  },{0,bb }},
/*12 */{{12,fl  },{12,fl  },{12,fl  },{12,fl  },{12,fl  },{12,fl  },{12,fl  },{12,fl },{12,fl  },{12,fl  },{13,fl  },{ 0,fb  },{0,bb }},
/*13 */{{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb  },{ 0,fb },{ 0,fb  },{ 0,fl  },{12,fl  },{ 0,fb  },{0,bb }},
/*14 */{{14,fl  },{14,fl  },{14,fl  },{14,fl  },{14,fl  },{14,fl  },{14,fl  },{14,fl },{14,fl  },{14,fl  },{14,fl  },{ 0,fl  },{0,bb }}
...
{
	char vName[128+1];
  /* Kopiere Filename 3und teste auf .pl0 */
  strcpy(vName,fname);
...
tMorph* Lex(void)
{
	...
	do
  {
		...
		{
			printf(ANSI_COLOR_RED " >> Invalid Character: %c! -> no umlauts!\n",X);
			exit(EXIT_FAILURE);
		}
